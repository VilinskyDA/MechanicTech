...
### 6.2 Базовые роли (для классификации и UI)
...
### 6.5 Предрасчёт физики на этапе валидации
...
### 7.3 Окружение как материальные барьеры + распространение
...
### 10.2 Эффективная толщина и режим контакта
...
### 11.5 Предрасчитанные таблицы (response surfaces)
...
### 12.1 Поля кинетического канала (Impact Packet)
